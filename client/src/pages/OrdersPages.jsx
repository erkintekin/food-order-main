...
function OrdersPage() {
  ...
  return (
    <div className="container">
      <h2 className="display-2 text-warning">My Orders</h2>
      ...
      {orders.map((order) => (
        <div className="row border border-3 border-warning shadow-lg p-3 mb-5 bg-body-tertiary rounded bg-light text-warning">
            ...
            <div className="row border border-2 border-danger my-2 siparisler">
              <div className="col-md-12">
                <div className="row">
                  ...
                  <div className="col-md-4">
                    <div style={{ paddingTop: "35px" }}>
                      <h4 className="text-black">Adress Info:</h4>
          ...
          <div className="row">
            <div className="col-md-12">
              <div style={{ paddingTop: "35px" }}>
                <h4 className="text-black">Order Info:</h4>
                ...
                <p className="text-black">Order No.: {order._id} </p>
              </div>
            </div>
          </div>
        </div>
